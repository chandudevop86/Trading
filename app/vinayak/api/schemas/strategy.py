...
class LiveAnalysisRequest(BaseModel):
    ...
    paper_log_path: str = Field(default='app/vinayak/data/paper_trading_logs_all.csv')
    live_log_path: str = Field(default='app/vinayak/data/live_trading_logs_all.csv')
