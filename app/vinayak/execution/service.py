...
from vinayak.domain.models import (  # noqa: E402
    AuditEvent,
    AuditEventType,
...
from vinayak.execution.events import (  # noqa: E402
    TRADE_EXECUTED,
    TRADE_EXECUTION_REJECTED,
    TRADE_EXECUTE_REQUESTED,
)
from vinayak.execution.guard import ExecutionGuard  # noqa: E402
from vinayak.execution.repositories import AuditRepositoryPort, ExecutionRepositoryPort  # noqa: E402
...
class ProductionExecutionService:
    """Phase 6 canonical execution orchestration.

    This service is additive and intentionally leaves the older ExecutionService in place
    ...
    def execute(self, request: DomainExecutionRequest, *, daily_realized_pnl: Decimal = Decimal('0')) -> DomainExecutionResult:
