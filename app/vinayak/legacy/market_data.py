...
try:
    from vinayak.data.live_ohlcv import fetch_live_ohlcv as fetch_legacy_live_ohlcv
...
try:
    from vinayak.data.dhan_api import load_security_map as load_legacy_security_map
except ModuleNotFoundError:
    try:
