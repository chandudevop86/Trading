    ...
    <div class=\"layout\">
      <section id=\"controlSection\" class=\"card\">
        ...
        <div class=\"grid4\" style=\"margin-top:12px;\">
          ...
          <div><label for=\"paperLogPath\">Paper Log Path</label><input id=\"paperLogPath\" value=\"app/vinayak/data/paper_trading_logs_all.csv\" /></div>
          <div><label for=\"liveLogPath\">Live Log Path</label><input id=\"liveLogPath\" value=\"app/vinayak/data/live_trading_logs_all.csv\" /></div>
        </div>
        <div class=\"grid4\" style=\"margin-top:12px;\">
        ...
        <div class=\"grid2\" style=\"margin-top:12px;\">
          <div><label for=\"securityMapPath\">Security Map Path</label><input id=\"securityMapPath\" value=\"app/vinayak/data/dhan_security_map.csv\" /></div>
      ...
      <div class=\"stack\">
        <section class=\"card\">
          ...
          <div class=\"grid4\" style=\"margin-top:12px;\">
            ...
            <div class=\"metric\"><div class=\"label\">Paper Log</div><strong id=\"paperLogView\" style=\"font-size:16px;\">app/vinayak/data/paper_trading_logs_all.csv</strong></div>
            <div class=\"metric\"><div class=\"label\">Live Log</div><strong id=\"liveLogView\" style=\"font-size:16px;\">app/vinayak/data/live_trading_logs_all.csv</strong></div>
            <div class=\"metric\"><div class=\"label\">Security Map</div><strong id=\"securityMapView\" style=\"font-size:16px;\">app/vinayak/data/dhan_security_map.csv</strong></div>
          </div>
        </section>
