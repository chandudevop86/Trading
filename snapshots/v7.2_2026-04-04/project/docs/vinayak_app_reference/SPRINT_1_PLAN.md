...
- `app/vinayak/strategies/breakout/service.py`
...
- `app/vinayak/strategies/common/base.py`
...
- `app/vinayak/db/models/signal.py`
- `app/vinayak/db/models/execution.py`
- `app/vinayak/db/models/__init__.py`
...
- `app/vinayak/db/repositories/signal_repository.py`
- `app/vinayak/db/repositories/execution_repository.py`
...
- `app/vinayak/api/schemas/strategy.py`
- `app/vinayak/api/schemas/signal.py`
...
- `app/vinayak/api/routes/strategies.py`
...
- `tests/unit/vinayak/test_breakout_strategy.py`
- `tests/unit/vinayak/test_health_route.py`
- `tests/unit/vinayak/test_strategy_route.py`
