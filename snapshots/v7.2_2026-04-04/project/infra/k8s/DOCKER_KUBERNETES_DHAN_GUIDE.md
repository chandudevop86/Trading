...
```bash
cd /opt/intratrade
vim infra/docker/Dockerfile
vim infra/docker/docker-compose.yml

# Build image
docker build -f infra/docker/Dockerfile -t intratrade:latest .
...
# Then update infra/k8s/deployment.yaml image:
