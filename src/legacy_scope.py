...
LEGACY_SURFACE: tuple[LegacySurfaceEntry, ...] = (
    ...
    LegacySurfaceEntry("legacy_main", "src.main", "cli", "py -3 -m src.main", status="deprecated", recommended_replacement="tools/run_auto_backtest.ps1"),
    LegacySurfaceEntry("legacy_nifty50", "src.nifty50", "cli", "py -3 -m src.nifty50", status="deprecated", recommended_replacement="tools/run_auto_backtest.ps1"),
    LegacySurfaceEntry("legacy_nifty_options", "src.nifty_options", "cli", "py -3 -m src.nifty_options", status="deprecated", recommended_replacement="streamlit run src/Trading.py"),
    LegacySurfaceEntry("legacy_nifty_futures", "src.nifty_futures", "cli", "py -3 -m src.nifty_futures", status="deprecated", recommended_replacement="streamlit run src/Trading.py"),
